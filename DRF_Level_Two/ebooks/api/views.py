...
from DRF_Level_Two.permissions import IsAdminUserOrReadOnly, IsReviewAuthorOrReadOnly
from DRF_Level_Two.pagination import SmallSetPagination
...
class ReviewCreateAPIView(generics.CreateAPIView):
    ...
    def perform_create(self, serializer):
        ...
        if review_queryset.exists():
            raise ValidationError("Solo puedes una ves")
